...
14. [Global simulation order](specs/001-single-level-vertical-slice/simulation-order.md)
15. [Encounter objectives and Extraction gate](specs/001-single-level-vertical-slice/encounter-objectives.md)
16. [Runtime kernel schema](contracts/runtime-kernel-001.json)
17. [Contract version registry](contracts/versions.json)
18. [Implementation tasks](specs/001-single-level-vertical-slice/tasks.md)
19. [Legacy admission inventory](specs/001-single-level-vertical-slice/legacy-admission.md)
20. [Acceptance and playtest gates](specs/001-single-level-vertical-slice/acceptance.md)
21. [Decision register](specs/001-single-level-vertical-slice/decisions.md)
